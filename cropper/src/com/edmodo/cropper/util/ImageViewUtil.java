...
public class ImageViewUtil {
	...
	public static Rect getBitmapRectFitCenter(Bitmap bitmap, View view) {
		...
		return getBitmapRectFitCenter(bitmapWidth, bitmapHeight, viewWidth,
				viewHeight);
	}

	public static Rect getBitmapRectFitCenter(int bitmapWidth,
			int bitmapHeight, int viewWidth, int viewHeight) {
		return getBitmapRectFitCenterHelper(bitmapWidth, bitmapHeight,
	...
	private static Rect getBitmapRectFitCenterHelper(int bitmapWidth,
		...
		//Log.v("CROP_VIEW", "bitmapRect h: " + bitmapHeight + ", w: " + bitmapWidth);
		//Log.v("CROP_VIEW", "viewRect h: " + viewHeight + ", w: " + viewWidth);
		...
		//if (bitmapWidth < viewWidth) {
			double bitmapToViewWidthRatio = (double) bitmapWidth / (double) viewWidth;
		//}
		//if (bitmapHeight < viewHeight) {
			double bitmapToViewHeightRatio = (double) bitmapHeight
					/ (double) viewHeight;
		//}
		...
		final Rect result = new Rect(resultX, resultY, resultX
				+ (int) Math.ceil(resultWidth), resultY
				+ (int) Math.ceil(resultHeight));
		
		//Log.v("CROP_VIEW", "resultRect h: " + result.height() + ", w: " + result.width() + "\n\n");
